...
export default function RoomsPage() {
  ...
  const CardImageCarousel = ({ images, roomId, onImageClick }) => {
        ...
        {images && images.length > 0 ? (
          <>
            <motion.img
              ...
              alt={`Room image ${currentImgIndex + 1}`}
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-blue-200/80 text-sm">
            Manage and view all rooms in your system
          </p>
        </div>
        <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {rooms.map((room, index) => (
            <motion.div
              ...
              className={`bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 relative ${
            ...
            >
              ...
              {room.availability === "Occupied" && (
                <div className="absolute inset-0 bg-black/60 flex items-center justify-center z-10">
                  <div className="bg-red-500/90 text-white px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2">
                    🚫 Occupied
                  </div>
                </div>
              )}
              ...
              <div className="p-5">
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-blue-200 text-sm">
                    {room.type === "Other"
                      ? room.customType || "Custom Type"
                      : room.type}
                  </span>
                </div>

                {/* Price and Booking Fee */}
                <div className="grid grid-cols-2 gap-3 mb-4">
                  {room.price && (
                    <div className="text-center bg-blue-500/20 rounded-lg p-2">
                      <p className="text-lg font-bold text-[#FFD601]">
                        ₵{room.price}
                      </p>
                  ...
                  {room.booking_price && (
                    <div className="text-center bg-green-500/20 rounded-lg p-2">
                      ...
                      <p className="text-xs text-blue-200/60">booking fee</p>
                    </div>
                  )}
                </div>
                ...
                {/* Payment Mode */}
                {room.payment_mode && (
                  <div className="flex items-center gap-2 mb-3 text-blue-200/70 text-sm">
                    <Calendar size={14} />
                    <span className="line-clamp-1">{room.payment_mode}</span>
                  </div>
                )}
                ...
                <div className="flex gap-2 pt-3 border-t border-white/10">
                  <Link
                    href={`/dashboard/admin/rooms/edit/${room.id}`}
